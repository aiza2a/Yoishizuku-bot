...
checks = {
    ...
    "guest_reads_quoted_photo": "quoted_image_id" in bot and "get_image_message(encoded" in bot,
    "guest_hides_image_url": "preview_url=generated_image" in bot and "hidden_link" not in bot,
    ...
    "persona_enforces_third_person": "### 人称一致性（强制）" in (ROOT / "persona" / "modules" / "07_voice.md").read_text(encoding="utf-8"),
    "self_check_covers_person": "只有引号内台词才用“我”" in (ROOT / "persona" / "modules" / "15_self_check.md").read_text(encoding="utf-8"),
    "persona_forbids_progress_narration": "不要输出“生成中”" in (ROOT / "persona" / "modules" / "13_task_execution.md").read_text(encoding="utf-8"),
